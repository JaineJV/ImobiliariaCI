                        ...
                        <div class="card-body">
                            <form action="" method="POST">
                                <div class="form-row text-center">
                                    <input type="hidden" name="id" value="<?= (isset($bairro)) ? $bairro->id_bairro : ''; ?>">
                                    
                                    <div class="col-md-11 mb-3">
                                    <label for="cd_cidade" style="margin-left: 10px; margin-top: 10px"> Cidade: </label>
                                    <select id="cd_cidade" class="form-control" name="cd_cidade" style="margin-left: 12px;">
                                    ...
                                    <div class="col-md-11 mb-3">
                                        <label for="nome_bairro" style="margin-left: 10px; margin-top: 10px"> Bairro: </label>
                                        <input type="text" name="nome_bairro" id="nome_bairro" class="form-control" value="<?= (isset($bairro)) ? $bairro->nome_bairro : ''; ?>" style="margin-left: 12px;">
                                    </div>
                                    <div class="col">
