                ...
                <div class="card-body">
                    <form action="" method="POST">
                        <div class="form-row text-center">
                            <input type="hidden" name="id" value="<?= (isset($cidade)) ? $cidade->id_cidade : ''; ?>">
                            <div class="col-md-11 mb-3">
                                <label for="nome_cidade"> Cidade: </label>
                                <input type="text" name="nome_cidade" id="nome_cidade" class="form-control" value="<?= (isset($cidade)) ? $cidade->nome_cidade : ''; ?>" style="margin-left: 12px;">
                            </div>
                            <div class="col">
