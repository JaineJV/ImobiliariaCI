        ...
        <table class="table table-bordered bg-white text-center" style="margin-top: 10px;">
            ...
            <tbody>
                ...
                foreach ($categorias as $key => $c) {
                    echo '<tr>';
                    echo '<td scope="row">' . $c->nome_categoria . '</td>';
                    echo '<td scope="row" style="text-align: center;">'
                    . '<a href="' . $this->config->base_url() . 'Categoria/alterar/' . $c->id_categoria . '" class="btn btn-danger" style="margin-right:4px;"><i class="far fa-edit"></i> Alterar </a>'
                    . '<a href="' . $this->config->base_url() . 'Categoria/deletar/' . $c->id_categoria . '" class="btn btn-outline-secondary"><i class="far fa-trash-alt"></i> Deletar </a></td>';
