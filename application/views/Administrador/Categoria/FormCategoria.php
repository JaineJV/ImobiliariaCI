                    ...
                    <form action="" method="POST">
                        <div class="form-row text-center">
                            ...
                            <div class="col-md-11 mb-3">
                                <label for="nome_categoria" style="margin-left: 10px; margin-top: 10px"> Tipo Categoria: </label>
                                <input type="text" name="nome_categoria" id="nome_categoria" class="form-control" value="<?= (isset($categoria)) ? $categoria->nome_categoria : ''; ?>" style="margin-left: 12px;">
                            </div>
                            <div class="col">
